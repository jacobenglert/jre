...
```
```{r, eval = TRUE, echo = FALSE, out.width="90%", fig.cap='State Map'}
knitr::include_graphics('Figures/new_state_map.png')
```
...
```{r, eval = TRUE, echo = FALSE, out.width="90%", fig.cap='Country Map'}
knitr::include_graphics('Figures/new_country_map.png')
```
