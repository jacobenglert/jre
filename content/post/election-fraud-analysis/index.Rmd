...
country_digits |>
  ...
  labs(x = 'Leading Digit in Total County Votes',
       ...
       color = "Party")
```
```{r label = distributions, eval = TRUE, echo = FALSE, out.width="90%", fig.cap='Distribution of Vote Totals', fig.align='center'}
knitr::include_graphics('Figures/county_vote_distributions.png')
```
...
```
```{r label = country_chisq, eval = TRUE, echo = FALSE, out.width="90%", fig.cap='Nationwide Chi-Square Test Results', fig.align='center'}
knitr::include_graphics('Figures/country_chisq.png')
```
...
us_states |>
  ...
  theme(axis.ticks = element_blank(),
        axis.text = element_blank())
```
```{r label = state_chisq, eval = TRUE, echo = FALSE, out.width="90%", fig.cap='State-level Chi-Square Test Results', fig.align='center'}
knitr::include_graphics('Figures/state_chisq.png')
```
...
us_states |>
  ...
  theme(axis.ticks = element_blank(),
        axis.text = element_blank())
```
```{r label = state_perm, eval = TRUE, echo = FALSE, out.width="90%", fig.cap='State-level Permutation Test Results', fig.align='center'}
knitr::include_graphics('Figures/state_perm.png')
```
